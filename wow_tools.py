...
class OBJECT_PT_WoW(bpy.types.Panel):
	...
	def draw(self, context):
		...
		layout_col3.label(text='')
		#row = layout_col3.row()
		#row.operator('scene.wow_toggle_attach_bones', text='', icon='BONE_DATA')
		layout_col3.label(text='')
		layout_col3.label(text='')
		row = layout_col3.row()
	...
	def register(Wow_Mesh_Props):
		...
		Wow_Mesh_Props.RenderFlags = bpy.props.EnumProperty(
			...
			items=[
				...
				('6', 'shadowBatchRelated1', '', 'None', 0x40),
				('7', 'shadowBatchRelated2', '', 'None', 0x80),
				('8', 'unk1', '', 'None', 0x100),
				('9', 'shadowBatchRelated3', '', 'None', 0x200),
				('10', 'unk2', '', 'None', 0x400),
				('11', 'preventAlpha', '', 'None', 0x800)
				],
			default={'3'},
			options={'ENUM_FLAG'}
			)
...
class Wow_EditBone_Props(bpy.types.PropertyGroup):
	...
	def register(Wow_EditBone_Props):
		...
		#Wow_EditBone_Props.Flags = bpy.props.IntProperty(
			...
			#min=0,
			#max=2147483647)
		Wow_EditBone_Props.Flags = bpy.props.EnumProperty(
			name='Bone Flags',
			description='Bone Flags',
			items=[
				('0', 'ignoreParentTranslate', '', 'None', 0x1),
				('1', 'ignoreParentScale', '', 'None', 0x2),
				('2', 'ignoreParentRotation', '', 'None', 0x4),
				('3', 'spherical_billboard', '', 'None', 0x8),
				('4', 'cylindrical_billboard_lock_x', '', 'None', 0x10),
				('5', 'cylindrical_billboard_lock_y', '', 'None', 0x20),
				('6', 'cylindrical_billboard_lock_z', '', 'None', 0x40),
				('7', 'transformed', '', 'None', 0x80),
				('7', 'unk', '', 'None', 0x100),
				('8', 'TRANSFORMED', '', 'None', 0x200),
				('9', 'kinematic_bone', '', 'None', 0x400),
				('10', 'unk', '', 'None', 0x800),
				('11', 'helmet_anim_scaled', '', 'None', 0x1000),
				('12', 'something_sequence_id', '', 'None', 0x2000),
				('13', 'unk', '', 'None', 0x4000),
				('14', 'unk', '', 'None', 0x8000),
				('15', 'unk', '', 'None', 0x10000),
				('16', 'unk', '', 'None', 0x20000),
				('17', 'unk', '', 'None', 0x40000),
				('18', 'unk', '', 'None', 0x80000),
				('19', 'unk', '', 'None', 0x100000),
				('20', 'unk', '', 'None', 0x200000),
				('21', 'unk', '', 'None', 0x400000),
				('22', 'unk', '', 'None', 0x800000),
				('23', 'unk', '', 'None', 0x1000000),
				('24', 'unk', '', 'None', 0x2000000),
				('25', 'unk', '', 'None', 0x4000000),
				('26', 'unk', '', 'None', 0x8000000),
				('27', 'unk', '', 'None', 0x10000000),
				('28', 'unk', '', 'None', 0x20000000),
				('29', 'unk', '', 'None', 0x40000000),
				#('30', 'unk', '', 'None', 0x80000000),
				],
			default={'3'},
			options={'ENUM_FLAG'}
			)
		...
		Wow_EditBone_Props.Unknown1 = bpy.props.IntProperty(
			...
			min=0,
			max=65535)
		Wow_EditBone_Props.KeyBone = bpy.props.IntProperty(
			name="KeyBoneID",
			default=-1,
			min=0,
			max=65535)
	...
	def draw(self, context):
		...
		if targetType == "MESH":
			...
			if oTargetObject.mode == 'EDIT':
				...
				#props.Flags = BoneFlagsToSet()
				flagProp = box.prop(props, 'Flags', text='Bone Flags')
			
				box.prop(props, 'SubmeshId')
				unk_box = layout.box()
				unk_box.prop(props, 'Unknown0', emboss=False)
				unk_box.prop(props, 'Unknown1', emboss=False)
				#unk_box.prop(props, 'KeyBone', emboss=False)
				unk_box.enabled = False
